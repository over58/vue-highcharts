(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["HighchartsVueXyc"] = factory(require("highcharts"));
	else
		root["HighchartsVueXyc"] = factory(root["Highcharts"]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_highcharts__ = __webpack_require__(5);
...
var Chart = Object(__WEBPACK_IMPORTED_MODULE_0__component__["a" /* default */])(__WEBPACK_IMPORTED_MODULE_1_highcharts___default.a); // 作为全局组件提供使用
    ...
    watch: {
      options: {
        handler: function handler(newValue) {
          this.chart.update(Object(__WEBPACK_IMPORTED_MODULE_0_lodash__["cloneDeep"])(newValue), this.updatedRedraw);
        },
        deep: true
      }
    },
